  ...
  const fetchStats = async () => {
    try {
      ...
      const totalDocuments =
        customersWithDocs?.reduce((count, customer) => {
          return (
            count +
    ...
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {role === "admin" ? (
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <StatsCard
                    ...
                    trend={`+${(
                      (stats.thisMonth /
                        Math.max(stats.totalCustomers - stats.thisMonth, 1)) *
                      100
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Manage customer records and documents
                    </p>
                  </div>
          ...
          // Staff Dashboard (simpler)
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-foreground">My Customers</h2>
            <p className="text-muted-foreground">
              You can manage only your own customers
            </p>
            ...
            {/* Staff Records Table should be filtered by current user_id */}
